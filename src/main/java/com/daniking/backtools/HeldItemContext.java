...
public class HeldItemContext {
    ...
    public static boolean areStacksEqual(final @NotNull ItemStack a, final @NotNull ItemStack b) {
    ...
    public void tick(@NotNull ItemStack main, @NotNull ItemStack off) {
...
//        this.updatePreviousStacks(main, off);
    ...
    private void reset(@NotNull ItemStack entityStack) {
